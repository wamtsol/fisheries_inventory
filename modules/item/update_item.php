...
$sql="SELECT I.quantity as 'group_item_quantity' ,
			 IG.item_id as 'item_id'       		 ,
			 IG.quantity  as 'item_quantity'     ,
			 I.id as 'group_item_id'
			 from items as I INNER JOIN item_group as IG on IG.group_item_id=I.id where I.type='1'";
