...
<div class="page-header">
	<h1 class="title">Manage Stock Purchased</h1>
  	<ol class="breadcrumb">
    	<li class="active">Stock Purchased</li>
  	</ol>
  	<div class="right">
    	<div class="btn-group" role="group" aria-label="..."> 
            <?php if($admin_type["can_add"]==1){?><a href="supply_manage.php?tab=addedit" class="btn btn-light editproject">Add New Record</a><?php }?>
    	...
    	<tbody>
            ...
            if(numrows($rs)>0){
                ...
                while($r=dofetch($rs)){             
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <?php if($admin_type["can_edit"]==1){?><a href="supply_manage.php?tab=addedit&id=<?php echo $r['id'];?>"><img title="Edit Record" alt="Edit" src="images/edit.png"></a>&nbsp;&nbsp;<?php }?>
                            <?php if($admin_type["can_delete"]==1){?><a onclick="return confirm('Are you sure you want to delete')" href="supply_manage.php?id=<?php echo $r['id'];?>&amp;tab=delete"><img title="Delete Record" alt="Delete" src="images/delete.png"></a><?php }?>
                        </td>
                    </tr>
                    <?php 
                    $sn++;
                ...
                <tr>
                    ...
                    <td colspan="6" class="paging" title="Paging" align="right"><?php echo pages_list($rows, "supply", $sql, $pageNum)?></td>
                </tr>
                <?php	
            }
            else{	
