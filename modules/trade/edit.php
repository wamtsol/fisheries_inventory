...
<form class="form-horizontal form-horizontal-left" role="form" action="trade_manage.php?tab=edit" method="post" enctype="multipart/form-data" name="frmAdd">
    ...
    <div class="form-group">
    	<div class="row">
            ...
            <div class="col-sm-10">
                <input type="submit" value="Update" class="btn btn-default btn-l" name="trade_edit" title="Update Record" />
            </div>
        </div>
  	</div>
</form>