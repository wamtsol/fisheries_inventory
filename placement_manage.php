...
if(isset($_GET["trade_id"])){
	$trade_id=slash($_GET["trade_id"]);
	$_SESSION["placement"]["list"]["trade_id"]=$trade_id;
}
if(isset($_SESSION["placement"]["list"]["trade_id"])){
	$trade_id=$_SESSION["placement"]["list"]["trade_id"];
}
else{
	$trade_id="";
}
if($trade_id!=""){
	$extra.=" and a.trade_id='".$trade_id."'";
	$is_search=true;
}
if(isset($_GET["location_id"])){
	$location_id=slash($_GET["location_id"]);
	$_SESSION["placement"]["list"]["location_id"]=$location_id;
}
if(isset($_SESSION["placement"]["list"]["location_id"])){
	$location_id=$_SESSION["placement"]["list"]["location_id"];
}
else{
	$location_id="";
}
if($location_id!=""){
	$extra.=" and a.location_id='".$location_id."'";
	$is_search=true;
}
$order_by = "date";
$order = "desc";
