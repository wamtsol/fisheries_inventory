...
<div ng-app="supply" ng-controller="supplyController" id="supplyController">
    ...
    <div class="page-header">
        <h1 class="title">{{get_action()}} Stock Purchased</h1>
        <ol class="breadcrumb">
            <li class="active">Manage Stock Purchased</li>
        </ol>
        <div class="right">
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-sm-10">
                <textarea title="Enter Detail" name="note" id="note" class="form-control" ng-model="supply.note">{{ supply.note }}</textarea>
            </div>
        </div>
    </div>
