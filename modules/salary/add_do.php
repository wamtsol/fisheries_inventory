...
if(isset($_POST["salary_add"])){
	...
	if($err==""){
		$sql="INSERT INTO salary (employee_id, month, year, datetime_added, amount) VALUES ('".slash($employee_id)."', '".slash($month)."', '".slash($year)."', '".slash(datetime_dbconvert($datetime_added))."', '".slash($amount)."')";
		doquery($sql,$dblink);
