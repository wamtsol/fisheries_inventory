...
<div class="page-header">
	<h1 class="title">Manage Store Payment</h1>
  	<ol class="breadcrumb">
    	<li class="active">All Store Payment</li>
  	</ol>
  	<div class="right">
    	<div class="btn-group" role="group" aria-label="..."> 
        	<a href="store_payment_manage.php?tab=add" class="btn btn-light editproject">Add New Record</a> <a id="topstats" class="btn btn-light" href="#"><i class="fa fa-search"></i></a>
            <a class="btn print-btn" href="store_payment_manage.php?tab=print"><i class="fa fa-print" aria-hidden="true"></i></a>
        </div>
  	</div>
</div>
	...
	<li class="col-xs-12 col-lg-12 col-sm-12">
        <div>
        	<form class="form-horizontal" action="" method="get">
            	<div class="col-sm-3">
                	<select name="store_id" id="store_id" class="custom_select">
                        <option value=""<?php echo ($store_id=="")? " selected":"";?>>Select Store</option>
                        <?php
            ...
            if(numrows($rs)>0){
                ...
                while($r=dofetch($rs)){             
                    ...
                    <tr>
                        ...
                        <td class="text-center"><a href="store_payment_manage.php?id=<?php echo $r['id'];?>&tab=status&s=<?php echo ($r["status"]==0)?1:0;?>">
                            <?php
                            if($r["status"]==0){
                                ?>
                        ...
                        <td class="text-center">
                            <a href="store_payment_manage.php?tab=edit&id=<?php echo $r['id'];?>"><img title="Edit Record" alt="Edit" src="images/edit.png"></a>&nbsp;&nbsp;
                            <a onclick="return confirm('Are you sure you want to delete')" href="store_payment_manage.php?id=<?php echo $r['id'];?>&amp;tab=delete"><img title="Delete Record" alt="Delete" src="images/delete.png"></a>
                        </td>
                    </tr>
                    <?php 
                    $sn++;
                ...
                <tr>
                    ...
                    <td colspan="4" class="paging" title="Paging" align="right"><?php echo pages_list($rows, "store_payment", $sql, $pageNum)?></td>
                </tr>
                <?php	
            }
            else{	
