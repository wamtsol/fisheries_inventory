	...
	<h1 class="title"><?php echo $store["title"]?></h1>
  	...
  	<div class="right">
    	<div class="btn-group" role="group" aria-label="..."> 
        	<a href="store_manage.php?tab=list" class="btn btn-light editproject">Back to List</a>
            <a class="btn print-btn" href="store_manage.php?tab=report_debit_credit_print&id=<?php echo $store["id"];?>"><i class="fa fa-print" aria-hidden="true"></i></a> 
	...
	<table class="table table-hover list">
    	<thead>
            <tr>
                ...
                <th>
                    <a href="store_manage.php?tab=report_debit_credit&id=<?php echo $store["id"]?>order_by=date&order=<?php echo $order=="asc"?"desc":"asc"?>" class="sorting">
                        Date
                        <?php
                        if( $order_by == "date" ) {
                            ?>
