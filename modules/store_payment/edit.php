...
<div class="page-header">
	<h1 class="title">Edit Store Payment</h1>
  	<ol class="breadcrumb">
...
<form action="store_payment_manage.php?tab=edit" method="post" enctype="multipart/form-data" name="frmAdd"  class="form-horizontal form-horizontal-left">
    ...
    <div class="form-group">
    	<div class="row">
            ...
            <div class="col-sm-10">
                ...
                <?php if(!empty($payment_image)) { ?><a href="<?php echo $file_upload_root?>store_payment_image/<?php echo $payment_image; ?>" target="_blank"><img src="<?php echo $file_upload_root?>store_payment_image/<?php echo $payment_image; ?>"  alt="image" title="<?php echo $id;?>" style="width: 50px;margin-right: 10px;" /></a><input type="checkbox" name="delete_image" id="delete_image" class="delete-image" value="1" />&nbsp;<label for="delete_image">Delete This Image</label><?php } ?>
            </div>
        </div>
  	</div>
  	<div class="form-group">
    	<div class="row">
            ...
            <div class="col-sm-10">
                <input type="submit" value="UPDATE" class="btn btn-default btn-l" name="store_payment_edit" title="Update Record" />
            </div>
        </div>
  	</div>
</form>