...
<div id="main">
    ...
    <div id="receipt">STORE RECEIPT</div>
    <div class="contentbox">
            ...
            if(numrows($items)>0){
                ...
                while($item=dofetch($items)){
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; font-size:9px;"><?php echo $item["type"]?implode("/",$pricenew):implode("/",$price);?></td>
                        <td style="text-align:right; font-size:9px;"><?php echo $item["total_price"]?></td>
        ...
        <?php if($sale["discount"]>0){?><p><strong>TOTAL</strong><strong style="float:right">Rs. <?php echo $sale["total_price"]?></strong></p>
        <p><strong>Discount</strong><strong style="float:right">Rs. <?php echo curr_format($sale["discount"])?></strong></p><?php }?>
        <p><strong>TOTAL</strong><strong style="float:right">Rs. <?php echo $sale["net_price"]?></strong></p>
